...
existing infrastructure to build R package binaries at scale. The dedicated
hardware would make it practical to compile vignettes and run examples, providing
further robustness over installation checks.
